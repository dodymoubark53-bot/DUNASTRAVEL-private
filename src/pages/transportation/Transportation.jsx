          ...
          {filteredVehicles.map((vehicle, index) => (
            ...
            >
                  ...
                  <ul className="mb-6 space-y-2">
                    ...
                    {vehicle.features?.length > 3 && (
                      <li className="text-caption text-obsidian-500 italic">
                        {t('transportation.moreFeatures', '+ {{count}} more features', { count: vehicle.features.length - 3 })}
                      </li>
                    )}
                  </ul>
                </div>
              ...
              <div className="px-6 pb-6 pt-2 flex items-center justify-between border-t border-gray-100 mt-auto">
                <div>
                  <span className="text-body-lg font-bold text-obsidian-900">{formatPrice(vehicle.pricePerDay || 0)}</span>
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center p-6 md:p-10">
          <div>
            ...
            <p className="text-body-lg text-ivory-300 mb-8 leading-relaxed">
              {t('transportation.static.desc', 'Enjoy a smooth and comfortable journey with our private transfer services. Our professional drivers and representatives will be waiting for you at the airport, hotel, or any requested location to ensure a safe and hassle-free experience.')}
            </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between text-ivory-50 z-10">
                    <span className="text-caption text-gold-400 font-bold tracking-widest uppercase">DUNAS VIP FLEET</span>
          ...
          >
            ...
            <div className="flex items-center justify-between z-50 text-ivory-50">
              <div className="flex items-center gap-3">
                <span className="text-gold-500 font-bold text-lg font-display" style={{ fontFamily: "'Playfair Display', serif" }}>
                  DUNAS FLEET
                </span>
